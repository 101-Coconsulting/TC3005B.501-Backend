...
INSERT INTO Alert (user_id, alert_text) VALUES
  ...
  (2, 'New software update available for your system.'),
  (3, 'Security alert: Unusual activity detected on your account.'),
  (4, 'Your account has been successfully verified.'),
  (6, 'Unauthorized access attempt blocked.'),
  (7, 'You have 5 unread messages.'),
  (8, 'Scheduled downtime for server maintenance tomorrow at 3 PM.'),
  (9, 'Your subscription is about to expire.'),
  (10, 'New feature release: You can now integrate with third-party apps.'),
  (11, 'Password changed successfully.'),
  (12, 'Login attempt failed due to incorrect password.'),
  (13, 'System update completed successfully.'),
  (14, 'Reminder: Your payment is due in 2 days.'),
  (15, 'Your session will expire in 10 minutes.'),
  (16, 'Account recovery process initiated.'),
  (17, 'Alert: A new user has been added to your team.'),
  (18, 'A new device has been registered to your account.'),
  (19, 'Please verify your email address to continue.'),
  (20, 'Your account has been temporarily locked due to multiple failed login attempts.'),
  (21, 'You have successfully unsubscribed from notifications.'),
  (22, 'New notification from your favorite channel!'),
  (23, 'A new comment has been posted on your profile.'),
  (24, 'Server overload detected. Performance may be affected.'),
  (25, 'Your credit card has been successfully charged.'),
  (26, 'Your account password has been reset.'),
  (27, 'Access request denied for unauthorized IP address.'),
  (28, 'You have been assigned a new role in the system.'),
  (29, 'New security patch applied to your system.'),
  (30, 'Upcoming system maintenance scheduled for the weekend.'),
  (31, 'Your recent transaction has been flagged for review.'),
  (32, 'Your account balance is low, please top up soon.'),
  (33, 'Scheduled update to improve system performance.'),
  (34, 'Your email address was updated successfully.'),
  (35, 'Two-factor authentication has been enabled for your account.'),
  (36, 'New terms and conditions have been added, please review.'),
  (37, 'System-wide upgrade is in progress, expect delays.'),
  (38, 'You have been granted access to a premium feature.'),
  (39, 'Your profile picture has been updated.'),
  (40, 'We noticed unusual login times, please check your recent activity.');
